  ...
  <div class="content-wrapper">
    ...
    <div class="pad margin no-print">
      <div class="callout callout-info" style="margin-bottom: 0!important;">
        ...
        좀비 킬 수를 기준으로 표시됩니다. 한시간 이내 플레이어는 랭킹에 포함 되지 않습니다.
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-xs-12 table-responsive">
          <table class="table table-striped">
            ...
            <tr>
              <td><?php $ii++; echo $ii; ?></td>
            <td><?php echo $row['p_name']?></td>
              <td><?php for($count = -1; $count <=19; $count++){
                    if ($row['p_weapontype'] == $count) { echo $weapon_arrays[$count]; }
                  }?></td>
              <td><?php echo $row['p_zombiekills']?></td>
              <td><?php echo $row['p_hours']?>시간</td>
            </tr>
                <?php }
        ...
        <center><p><b>WarZ Rank System</b></p></center>
      </div>
        <!-- /.col -->
      </div>
      <!-- /.row -->
